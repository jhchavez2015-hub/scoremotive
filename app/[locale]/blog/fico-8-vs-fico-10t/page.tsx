...
const content: Record<Locale, {
  ...
  en: {
    title: "FICO 8 vs FICO 10T: What's the Difference and Why It Matters",
    subtitle: "Most Americans don't know there are multiple FICO models. The difference can mean thousands of dollars on your next loan.",
    readSuffix: "min read",
    ctaTitle: "Want to see both your scores right now?",
    ctaDesc: "Use our free Dual Score Estimator — it estimates both scores side by side.",
    ctaBtn: "Try the Tools Free",
    disclaimerText: "ScoreMotive is an educational tool. Results are estimates and do not replace a report from an official credit bureau. Always consult a Certified Financial Planner (CFP) before making major financial decisions.",
    toolsLabel: "Tools",
    relatedTitle: "Related Articles",
  },
  es: {
    title: "FICO 8 vs FICO 10T: Cuál es la Diferencia y Por Qué Importa",
    subtitle: "La mayoría de los americanos no saben que existen múltiples modelos FICO. La diferencia puede significar miles de dólares en tu próximo préstamo.",
    readSuffix: "min lectura",
    ctaTitle: "¿Quieres ver tus dos puntajes ahora?",
    ctaDesc: "Usa nuestro Estimador de Score Dual gratuito — estima ambos puntajes lado a lado.",
    ctaBtn: "Probar las Herramientas Gratis",
    disclaimerText: "ScoreMotive es una herramienta educativa. Los resultados son estimaciones y no reemplazan un reporte oficial de las agencias de crédito. Consulta siempre a un Planificador Financiero Certificado (CFP) antes de tomar decisiones financieras importantes.",
...
export default async function FicoArticlePage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
