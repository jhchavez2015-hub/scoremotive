...
const SLUG = "raise-credit-score-100-points";
...
const content: Record<Locale, {
  ...
  en: {
    title: "How to Raise Your Credit Score 100 Points in 6 Months",
    subtitle: "An action plan based on how FICO actually calculates your score. No gimmicks or shortcuts — just the moves that actually work.",
    readSuffix: "min read",
    ctaTitle: "Want to see your estimated FICO score right now?",
    ctaDesc: "Use our free Dual Score Estimator — answer 5 questions and see where you stand on both models.",
    ctaBtn: "Analyze My Score Free",
    disclaimerText: "ScoreMotive is an educational tool. Results and timelines are estimates. Always consult a Certified Financial Planner (CFP) before making major financial decisions.",
    toolsLabel: "Tools",
    relatedTitle: "Related Articles",
  },
  es: {
    title: "Cómo Subir tu Credit Score 100 Puntos en 6 Meses",
    subtitle: "Un plan de acción basado en cómo FICO realmente calcula tu puntaje. Sin trucos ni atajos — solo los movimientos que realmente funcionan.",
    readSuffix: "min lectura",
    ctaTitle: "¿Quieres ver tu puntaje FICO estimado ahora?",
    ctaDesc: "Usa nuestro Estimador de Score Dual gratuito — responde 5 preguntas y ve dónde estás parado en ambos modelos.",
    ctaBtn: "Analizar mi Score Gratis",
    disclaimerText: "ScoreMotive es una herramienta educativa. Los resultados y tiempos son estimaciones. Consulta siempre a un Planificador Financiero Certificado (CFP) antes de tomar decisiones financieras importantes.",
...
export default async function RaiseScoreArticlePage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
    ...
    <main className="min-h-screen bg-[#080b12] text-[#f0f2f7] font-sans">
      ...
      <article className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="mt-12 bg-[#0d1220] border border-white/[0.07] rounded-2xl p-7 text-center">
          ...
          <a href={`/${locale}/tools`} className="inline-flex items-center gap-2 bg-gradient-to-r from-[#f59e0b] to-[#4f7cff] text-white px-8 py-3 rounded-xl text-sm font-medium hover:opacity-90 transition-all">
            {t.ctaBtn}
